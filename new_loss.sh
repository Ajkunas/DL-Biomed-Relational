...
# swissprot
python run.py exp.name=experiment-5-swissprot method=relationnet dataset=swissprot n_way=5 n_shot=5 n_query=5 exp.run_name=relation-5shot-5query
python run.py exp.name=experiment-5-swissprot method=relationnet dataset=swissprot n_way=5 n_shot=5 n_query=10 exp.run_name=relation-5shot-10query
python run.py exp.name=experiment-5-swissprot method=relationnet dataset=swissprot n_way=5 n_shot=5 n_query=15 exp.run_name=relation-5shot-15query
python run.py exp.name=experiment-5-swissprot method=relationnet dataset=swissprot n_way=5 n_shot=5 n_query=20 exp.run_name=relation-5shot-20query
...
# swissprot
python run.py exp.name=experiment-5-swissprot method=relationnet dataset=swissprot n_way=5 n_shot=1 n_query=15 exp.run_name=relation-1shot
python run.py exp.name=experiment-5-swissprot method=relationnet dataset=swissprot n_way=5 n_shot=2 n_query=15 exp.run_name=relation-2shot
python run.py exp.name=experiment-5-swissprot method=relationnet dataset=swissprot n_way=5 n_shot=3 n_query=15 exp.run_name=relation-3shot
python run.py exp.name=experiment-5-swissprot method=relationnet dataset=swissprot n_way=5 n_shot=4 n_query=15 exp.run_name=relation-4shot
python run.py exp.name=experiment-5-swissprot method=relationnet dataset=swissprot n_way=5 n_shot=5 n_query=15 exp.run_name=relation-5shot
